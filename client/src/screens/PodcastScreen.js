  ...
  return (
    <div className="bg-background px-4 md:px-10 max-w-8xl mx-auto h-screen">
      ...
      <div className="hidden sm:grid  grid-cols-9 gap-2">
        ...
        <div className="col-span-6 h-full flex flex-col justify-center  space-y-5">
      ...
      {/* Description Section */}
      <div className="grid grid-cols-10 divide-x-1 divide-neutral-300">
        {/* Share Buttons */}
        <div className="col-span-2 flex flex-col pr-10 text-right">
          <h2 className="font-robotoLight text-xl">Share this podcast</h2>
        </div>
